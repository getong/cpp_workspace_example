...
hidden if the `ninja-example_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ninja-example_DEVELOPER_MODE` to the configure
...
Runs the executable target `ninja-example_exe`.
