...
hidden if the `cmake_project_demo_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `cmake_project_demo_DEVELOPER_MODE` to the configure
...
Runs the executable target `cmake_project_demo_exe`.
