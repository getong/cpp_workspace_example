...
hidden if the `lambda_example_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `lambda_example_DEVELOPER_MODE` to the configure
...
Runs the executable target `lambda_example_exe`.
